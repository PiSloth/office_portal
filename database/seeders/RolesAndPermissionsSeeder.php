...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $admin->syncPermissions([
            ...
            'scan-configs.view', 'scan-configs.create', 'scan-configs.update',
            'sessions.view', 'sessions.create', 'sessions.update', 'sessions.manage',
            'checks.view', 'checks.create', 'checks.update',
            'product-checks.view', 'product-checks.create', 'product-checks.update', 'product-checks.delete',
            'decisions.view', 'decisions.create', 'decisions.update', 'decisions.assign',
            'reports.view',
        ]);
        ...
        $users = [
            ['name' => 'Super Admin User', 'email' => 'superadmin@maha.com', 'password' => 'password123', 'status' => 'ACTIVE', 'roles' => ['super-admin']],
            ['name' => 'Admin User', 'email' => 'admin@maha.com', 'password' => 'password123', 'status' => 'ACTIVE', 'roles' => ['admin']],
            ['name' => 'Manager User', 'email' => 'manager@maha.com', 'password' => 'password123', 'status' => 'ACTIVE', 'roles' => ['manager']],
            ['name' => 'Checker User', 'email' => 'checker@maha.com', 'password' => 'password123', 'status' => 'ACTIVE', 'roles' => ['checker']],
        ];
